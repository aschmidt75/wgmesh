...
var file_meshservice_proto_rawDesc = []byte{
	...
	0x56, 0x45, 0x10, 0x01, 0x32, 0x79, 0x0a, 0x04, 0x4d, 0x65, 0x73, 0x68, 0x12, 0x3d, 0x0a, 0x04,
...
var file_meshservice_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
var file_meshservice_proto_depIdxs = []int32{
	...
	4, // 3: meshservice.Mesh.Join:input_type -> meshservice.JoinRequest
	3, // 4: meshservice.Mesh.Peers:input_type -> meshservice.Empty
	5, // 5: meshservice.Mesh.Join:output_type -> meshservice.JoinResponse
	8, // 6: meshservice.Mesh.Peers:output_type -> meshservice.Peer
